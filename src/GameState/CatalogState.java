...
public class CatalogState extends GameState {
	...
	public void draw(Graphics2D g) {
		...
		*/
		...
		String string1m = newLine + newLine + newLine + newLine + newLine + newLine + "                 " + ("As established earlier, emotions are a means to establish a hierarchy." + newLine + "However in doing so an equilibrium is maintained, each time the entity   expresses the emotion. (e.g.: Anger caused by fear.)");
		...
		String string2m = newLine + newLine + newLine + newLine + newLine + newLine + "                 " + ("This equilibrium is shifted toward certain concious emotions over the other subconcious ones.      " + "Which then in turn defines that entity as a unique social entity with their own set of ideals based on these emotional     equilibriums.");
